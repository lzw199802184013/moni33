...
public class MingUtils {
     ...
     * 2：新浪登录
     */
    public static void login(final AppCompatActivity context, int type, final ResultListener listener) {
        ...
        UMShareAPI.get(context).getPlatformInfo(context, state, new UMAuthListener() {
            ...
            public void onComplete(SHARE_MEDIA share_media, int i, Map<String, String> map) {
                ...
                SharedPreferencesUtils.putString(context, "iconurl", iconurl);
